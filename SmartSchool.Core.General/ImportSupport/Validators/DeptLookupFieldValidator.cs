...
{
    class DeptLookupFieldValidator : IFieldValidator
    {
        private bool _skip_empty;
        private bool _activate_validator;
        private DeptLookup _lookup;
        private WizardContext _context;

        public DeptLookupFieldValidator(WizardContext context)
        {
            _context = context;
        }
        ...
        public void InitFromXMLNode(System.Xml.XmlElement XmlNode)
        {
            ...
            _lookup = _context.Extensions[DeptLookup.Name] as DeptLookup;
        }
