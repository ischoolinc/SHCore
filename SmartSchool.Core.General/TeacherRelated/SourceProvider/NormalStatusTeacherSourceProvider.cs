...
{
    class NormalStatusTeacherSourceProvider:DragDropTreeNode, ISourceProvider<BriefTeacherData, Search.ISearchTeacher>
    {
        private List<BriefTeacherData> _Source;

        private SearchTeacherInMetadata _SearchProvider;

        public NormalStatusTeacherSourceProvider()
        {
            this.Text = "所有教師(" + (_Source==null?0:_Source.Count) + ")";
        }
