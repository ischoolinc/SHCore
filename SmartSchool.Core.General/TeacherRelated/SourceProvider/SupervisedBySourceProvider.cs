...
{
    class SupervisedBySourceProvider :DragDropTreeNode, ISourceProvider<BriefTeacherData, Search.ISearchTeacher>
    {
        private List<BriefTeacherData> _Source;

        private SearchTeacherInMetadata _SearchProvider;

        public SupervisedBySourceProvider()
        {
            this.Text = "班導師(" + (_Source == null ? 0 : _Source.Count) + ")";
        }
